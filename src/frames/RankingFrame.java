...
public class RankingFrame extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(RankingFrame.class.getName());

    /**
     * Creates new form RankingFrame
     */
    public RankingFrame(Admin admin) {
        initComponents();
        setLocationRelativeTo(this);
        this.admin = admin;
        controller = new LibroController();
        RankingTable.setModel(controller.populateTableRanking());
        setData();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Ranking Libros");
        ...
        RankingTable.setBackground(new java.awt.Color(103, 153, 255));
